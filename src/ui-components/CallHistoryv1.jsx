...
export default function CallHistoryv1(props) {
  ...
  return (
    <View
      ...
      {...getOverrideProps(overrides, "CallHistoryv1")}
      {...rest}
    >
      <View
        padding="0px 0px 0px 0px"
      ...
      >
        ...
        <SearchField
          ...
          labelHidden={true}
          variation="default"
          {...getOverrideProps(overrides, "SearchField38602265")}
        ></SearchField>
        <Text
          fontFamily="Inter"
          fontSize="32px"
        ...
        <SearchField
          ...
          labelHidden={false}
          variation="default"
          {...getOverrideProps(overrides, "SearchField38602294")}
        ></SearchField>
        <Text
          fontFamily="Inter"
          fontSize="20px"
