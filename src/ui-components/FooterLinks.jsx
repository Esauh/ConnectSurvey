  ...
  return (
    ...
    >
      ...
      <Flex
        ...
        position="relative"
        padding="0px 0px 0px 0px"
        {...getOverrideProps(overrides, "Frame 40539681154")}
      >
        <Flex
          gap="8px"
          direction="column"
        ...
        >
          <Text
            ...
            whiteSpace="pre-wrap"
            children="Nav Links"
            {...getOverrideProps(overrides, "Nav Links")}
          ></Text>
          <Text
            fontFamily="Inter"
            fontSize="16px"
        ...
        <Flex
          ...
          position="relative"
          padding="0px 0px 0px 0px"
          {...getOverrideProps(overrides, "Frame 40539681159")}
        >
          <Text
            fontFamily="Inter"
            fontSize="16px"
            ...
            whiteSpace="pre-wrap"
            children="Reach Out"
            {...getOverrideProps(overrides, "Reach Out")}
          ></Text>
          <Text
            fontFamily="Inter"
            fontSize="16px"
